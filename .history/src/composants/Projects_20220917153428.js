...
import porfolio from "../assets/img/PortFolio_1.png";
import sncf from "../assets/img/logo_SNCF.jpg";
...
export const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      id: 3,
      title: "Pecheur.com",
      description: "Création d'une interface web pour trier est archiver les erreurs du programme web",
      imgUrl: projImg4,
    },
    {
      id: 2,
      title: "PortFolio",
      description: "Création d'un PortFolio en HTML/CSS",
      imgUrl: porfolio,
    },
    {
      id: 3,
      title: "SNCF",
      description: "Mise à jour de l'interface graphique",
      imgUrl: porfolio,
    },
  ];
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn": ""}>
                ...
                <Tab.Container id="projects-tabs" defaultActiveKey="first">
                  <Nav variant="pills" className="nav-pills mb-5 justify-content-center align-items-center" id="pills-tab">
                    ...
                    <Nav.Item>
                      <Nav.Link eventKey="third">Application</Nav.Link>
                    </Nav.Item>
                    <Nav.Item>
                      <Nav.Link eventKey="four">Réseau</Nav.Link>
                    </Nav.Item>
                  </Nav>
