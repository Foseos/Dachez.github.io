...
export const Contact = () => {
  ...
  const [buttonText, setButtonText] = useState('Envoyé');
  ...
  const handleSubmit = async (e) => {
    ...
    if (result.code == 200) {
      ...
      setStatus({ succes: false, message: 'Message non envoyé'});
    }
  };
              ...
              {({ isVisible }) =>
                ...
                <form onSubmit={handleSubmit}>
                  <Row>
                    ...
                    <Col size={12} sm={6} className="px-1">
                      <input type="text" value={formDetails.lasttName} placeholder="Prenom" onChange={(e) => onFormUpdate('lastName', e.target.value)}/>
                    </Col>
                    <Col size={12} sm={6} className="px-1">
