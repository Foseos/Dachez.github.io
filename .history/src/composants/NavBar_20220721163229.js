      ...
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ms-auto">
            ...
            <Nav.Link href="#projects" className={activeLink === 'Projets' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('')}>Projets</Nav.Link>
          </Nav>
          <span className="navbar-text">
            ...
            <button className="vvd" onClick={() => onUpdateActiveLink('connect')}><span>Contactez moi</span></button>
          </span>
        </Navbar.Collapse>
      </Container>
    </Navbar>
